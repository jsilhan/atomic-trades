...
class CommandTestCase(BaseTestCase):
    ...
    async def test_exchange_currency_command_evaluation_amount_in_buying_currency(self):
    ...
    async def test_exchange_currency_command_execution_amount_in_buying_currency(self):
        command = ExchangeCurrency(self.exchange, 'BTC', 'ETH', amount=4)
    ...
    async def test_exchange_currency_command_evaluation_insufficient_amount(self):
    ...
    async def test_raises_market_does_not_exists_error(self):
        with assert_raises(MarketDoesNotExistsError):
            ExchangeCurrency(self.exchange, 'BTC', 'SPX', amount=40)

    async def test_exchange_currency_command_evaluation_amount_in_buying_currency_eth(self):
    ...
    async def test_exchange_currency_command_execution_amount_in_buying_currency_eth(self):
        command = ExchangeCurrency(self.exchange, 'BTC', 'ETH', amount=4, in_currency='ETH')
        with assert_raises(PostConditionError) as cm:
            await execute_commands(command)
        assert_equal(cm.exception.failed_conditions,
    ...
    async def test_exchange_currency_command_reversed_symbol_amount_in_usd_currency(self):
    ...
    async def test_exchange_currency_command_evaluation_amount_in_usd_currency(self):
    ...
    async def test_exchange_currency_command_execution_amount_in_usd_currency(self):
    ...
    async def test_exchange_currency_command_evaluation_amount_in_selling_currency(self):
    ...
    async def test_exchange_currency_command_execution_amount_in_selling_currency(self):
        command = ExchangeCurrency(self.exchange, 'BTC', 'ETH', amount=1, in_currency='BTC')
        with assert_raises(PostConditionError) as cm:
            await execute_commands(command)
        assert_equal(cm.exception.failed_conditions,
    ...
    async def test_exchange_currency_command_evaluation_amount_in_selling_currency_insufficient_amount(self):
    ...
    async def test_exchange_all_currency_command_execution_success(self):
    ...
    async def test_exchange_all_currency_command_execution_success_reversed_symbol(self):
    ...
    async def test_exchange_all_currency_command_execution_unknown_balance_symbol_raises_pre_condition_error(self):
    ...
    async def test_execute_commands_raises_command_execution_error(self):
    ...
    async def test_negative_amount_passed_into_command(self):
        with assert_raises(AssertionError):
            ExchangeCurrency(self.exchange, 'ETH', 'BTC', -7)

    async def test_execute_till_command_creates_market_taker_after_timeout(self):
    ...
    async def test_execute_till_command_creates_market_taker_after_timeout_when_partially_filled(self):
    ...
    async def test_execute_till_command_not_creates_market_taker_when_filled_during_timeout_period(self):
    ...
    async def test_execute_till_command_not_creates_market_taker_when_filled_during_cancellation(self):
    ...
    async def test_execute_till_on_binance_handles_no_order_exception(self):
    ...
    async def test_sell_position_command_execution_amount_in_usd_currency(self):
    ...
    async def test_sell_position_command_execution_amount_in_future_price(self):
    ...
    async def test_sell_position_command_execution_amount_in_eth_currency(self):
    ...
    async def test_buy_position_command_execution_amount_in_usd_currency(self):
    ...
    async def test_buy_position_command_execution_amount_in_future_price(self):
    ...
    async def test_buy_position_command_execution_amount_in_eth_currency(self):
